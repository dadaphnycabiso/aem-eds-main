  ...
  return `
    ...
    <div>
      <div class="default-content-wrapper">
        ...
        <p><span class="icon icon-search"><img data-icon-name="search" src="/icons/search.svg" alt="Search"></span></p>
        <p class="button-container"><a href="/login" class="button"><span class="icon icon-user"><img data-icon-name="user" src="/icons/user.svg" alt=""></span> Log In</a></p>
      </div>
    </div>`;
}
